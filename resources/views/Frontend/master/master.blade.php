...
<head>
    ...
    <!-- Main css -->
    <link rel="stylesheet" href="{{ url('front-end/css/fontawesome-all.css') }}">
    <!-- Font-Awesome-Icons-CSS -->
    <link href="{{ url('front-end/css/popuo-box.css') }}" rel="stylesheet" type="text/css" media="all" />
    <!-- pop-up-box -->
    <link href="{{ url('front-end/css/menu.css') }}" rel="stylesheet" type="text/css" media="all" />
    <!-- menu style -->
    <!-- //Custom-Files -->
            ...
            <div class="col-md-3 logo_agile">
                <h1 class="text-center">
                    <a href="{{ route('/') }}" class="font-weight-bold font-italic">
                        <img src="{{ url('front-end/images/logo2.png') }}" alt=" " class="img-fluid">Electro Store
                    </a>
                </h1>
            </div>
            <!-- //logo -->
                ...
                <div class="join-agile text-left p-4">
                    <div class="row">
                        ...
                        <div class="col-sm-5 offerimg-w3l">
                            <img src="{{ url('front-end/images/off1.png') }}" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 mt-lg-0 mt-5">
                <div class="join-agile text-left p-4">
                    <div class="row ">
                        ...
                        <div class="col-sm-5 offerimg-w3l">
                            <img src="{{ url('front-end/images/off2.png') }}" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="agile-sometext py-md-5 py-sm-4 py-3">
        <div class="container">
            ...
            <div class="sub-some child-momu mt-4">
                ...
                <ul>
                    <li>
                        <img src="{{ url('front-end/images/pay2.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay5.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay1.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay4.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay6.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay3.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay7.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay8.png') }}" alt="">
                    </li>
                    <li>
                        <img src="{{ url('front-end/images/pay9.png') }}" alt="">
                    </li>
                </ul>
            </div>
            <!-- //payment -->
...
<!-- js-files -->
<!-- jquery -->
<script src="{{ url('front-end/js/jquery-2.2.3.min.js') }}"></script>
<!-- //jquery -->
...
<!-- scroll seller -->
<script src="{{ url('front-end/js/scroll.js') }}"></script>
<!-- //scroll seller -->
